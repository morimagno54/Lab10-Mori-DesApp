...
using neptuno_project.Models;

namespace neptuno_project.Controllers
{
    public class clientesController : Controller
    {
        ...
        {
            var activeClientes = db.clientes.Where(c => c.Activo).ToList();
            return View(activeClientes);
        }
        ...
        {
            clientes clientes = db.clientes.FirstOrDefault(c => c.idCliente == id && c.Activo);
